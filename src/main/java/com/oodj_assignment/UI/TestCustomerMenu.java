...
public class TestCustomerMenu extends javax.swing.JFrame {

    Customer customer;
    
    public TestCustomerMenu(Customer customer) {
        initComponents();
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestCustomerMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestCustomerMenu(null).setVisible(true);
            }
        });
    }
    ...
    private static javax.swing.JPanel bookingPanel;
